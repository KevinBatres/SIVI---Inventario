...
// -- obtiene el resultado de la consulta
        ResultSet rs = select.getEgresos();
...
<html>
    ...
    <body>
        <div class="bg-dark rounded shadow d-flex flex-row align-items-xl-center" style="background-color: rgb(255,255,255);width: 98%;height: 108%;margin: auto;margin-left: 17px;padding-top: 0px;">
            <div style="height: 94%;background-color: rgba(255,255,255,0.82);margin-top: 0px;">
                <div id="divt" class="table-responsive" style="width: 100%;height: 100%;margin-left: 0px;margin-bottom: 0px;">
                    <link rel="stylesheet" href="assets/bootstrap/css/bootstrap.min.css" media="print">
                    <table id="tablesal" class="table table-striped table-hover table-sm fonty">
                        <thead>
                            <tr>
                                <th style="width: 10%;">No. Salida</th>
                                <th>Descripcion</th>
                                <th style="width: 15%;">Fecha</th>
                                <th class="oculto-impresion"> Acciones </th>
                            </tr>
                        </thead>
                        <tbody>
                            <% while (rs.next()) {
                            ...
                            <tr>
                                ...
                                <td class="oculto-impresion">
                                    <form action="formsalida.jsp" name="formsalid" method="POST" >
                                        <input type="hidden" name="controlsalid" value="1">
                                        <input type="hidden" name="idet" value="<%=rs.getString(1)%>">

                                        <input type="hidden" name="enca" value="<%=rs.getString(4)%>">
                                        <input type="hidden" name="fech" value="<%=rs.getString(3)%>">
                                        <input type="hidden" name="desc" value="<%=rs.getString(2)%>">
                                        <input type="hidden" name="fact" value="<%=rs.getString(5)%>">
            ...
            <div class="text-break text-center d-inline-flex d-xl-flex flex-column align-items-xl-center" style="width: 18%;height: 82%;margin-top: 88px;margin-left: 22px;background-color: rgba(255,255,255,0);">
                ...
                <form name="formcontrol" method="POST" action="formsalida.jsp">
                    <input name="controlsalid" type="hidden" value="0" >
                    <button class="btn btn-primary d-inline-flex flex-column justify-content-xl-center align-items-xl-center" type="submit" style="margin-top: 298px;width: 110px;height: 45px;">Egresar</button>
                </form>
